...
UPlainSightGameInstance::UPlainSightGameInstance(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	/** Bind function for CREATING a Session */
	OnCreateSessionCompleteDelegate = FOnCreateSessionCompleteDelegate::CreateUObject(this, &UPlainSightGameInstance::OnCreateSessionComplete);
	OnStartSessionCompleteDelegate = FOnStartSessionCompleteDelegate::CreateUObject(this, &UPlainSightGameInstance::OnStartOnlineGameComplete);
	/** Bind function for FINDING a Session */
	OnFindSessionsCompleteDelegate = FOnFindSessionsCompleteDelegate::CreateUObject(this, &UPlainSightGameInstance::OnFindSessionsComplete);
...
void UPlainSightGameInstance::FindSessions(TSharedPtr<const FUniqueNetId> UserId, bool bIsLAN, bool bIsPresence)
{
...
void UPlainSightGameInstance::OnFindSessionsComplete(bool bWasSuccessful)
{
...
bool UPlainSightGameInstance::JoinSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName, const FOnlineSessionSearchResult& SearchResult)
{
	// Return bool
...
void UPlainSightGameInstance::OnJoinSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
...
void UPlainSightGameInstance::OnDestroySessionComplete(FName SessionName, bool bWasSuccessful)
{
...
void UPlainSightGameInstance::JoinOnlineGame(FSessionResult ChosenSession)
{
	...
	if (ChosenSession.ChosenSession.Session.OwningUserId != Player->GetPreferredUniqueNetId())
	{
		//SearchResult = SessionSearch->SearchResults[i];
